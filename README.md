...
| `hubs` | `create`, `list`, `retrieve`, `update`, `delete`; `navigation list/add/remove/reorder` (edit the menu item-by-item); `policies update`; `scaffold` (one-command full-experience hub from a template), `templates` (list templates) |
