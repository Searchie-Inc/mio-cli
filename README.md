...
| `--raw` | | false | Emit the raw JSON:API envelope instead of the flattened resource. On an API error, stderr is the API's own error document plus `meta.exit_code`. |
